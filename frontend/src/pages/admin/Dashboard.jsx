    ...
    const fetchAllData = async () => {
        ...
        try {
            ...
            if (statsResult.status === 'fulfilled' && statsResult.value.ok) {
                ...
                // Stats fetch failed - using cached data
            }
            ...
            if (sellersResult.status === 'fulfilled' && sellersResult.value.ok) {
                ...
                // Pending sellers fetch failed - using cached data
            }
            ...
            if (allSellersResult.status === 'fulfilled' && allSellersResult.value.ok) {
                ...
                // All sellers fetch failed - using pending sellers as fallback
            ...
            if (productsResult.status === 'fulfilled' && productsResult.value.ok) {
                ...
                // Products fetch failed - using cached data
            }
            ...
            if (ordersResult.status === 'fulfilled' && ordersResult.value.ok) {
                ...
                // Orders fetch failed - using cached data
            }
            ...
            if (analyticsResult && analyticsResult.status === 'fulfilled' && analyticsResult.value.ok) {
                ...
                // Analytics fetch failed - using cached data
            }
