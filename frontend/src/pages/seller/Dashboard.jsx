...
export default function SellerDashboard() {
    ...
    return (
        <div className="flex" style={{ minHeight: 'calc(100vh - 80px)', width: '100%', gap: '0', padding: '0' }}>
            ...
            <div className="flex-1 flex flex-col" style={{ padding: '1.5rem 2rem', background: '#f8fafc', gap: '2rem', height: 'calc(100vh - 80px)', overflowY: 'auto' }}>
                ...
                <div className="flex justify-between items-center">
                    <div>
                        <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#1e293b', marginBottom: '0.25rem' }}>Dashboard</h2>
                                    ...
                                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                        <thead style={{ background: '#1e293b', color: 'white', textAlign: 'left' }}>
                                            <tr>
                                                ...
                                                <th style={{ padding: '1.25rem 1.5rem', fontWeight: 600, fontSize: '0.85rem', letterSpacing: '0.05em', textTransform: 'uppercase', whiteSpace: 'nowrap' }}>MRP</th>
                                                <th style={{ padding: '1.25rem 1.5rem', fontWeight: 600, fontSize: '0.85rem', letterSpacing: '0.05em', textTransform: 'uppercase', whiteSpace: 'nowrap' }}>Selling Price</th>
                                            ...
                                            {products.map(p => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <td style={{ padding: '1.25rem 1.5rem' }}>
                                                            <span style={{ background: '#f1f5f9', color: '#475569', padding: '0.4rem 0.8rem', borderRadius: '50px', fontSize: '0.8rem', fontWeight: 600, border: '1px solid #e2e8f0' }}>
                                                                {p.category}
                                                            </span>
                                                        </td>
