...
export default function SellerPageWithAuth() {
  ...
  const isRegisterPage = currentPath === '/seller/register' || currentPath === '/seller/register/';
  const isLandingPage = currentPath === '/seller' || currentPath === '/';
  ...
  // Otherwise, show the normal seller landing page
  return (
