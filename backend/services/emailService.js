...
// Configure credentials from environment variables only
const MAILER_CONFIG = {
...
if (!MAILER_CONFIG.user || !MAILER_CONFIG.pass) {
    console.warn('⚠️  Email service not configured. Set MAILER_GOOGLE_USER_EMAIL and MAILER_GOOGLE_USER_PASSWORD in .env');
}
